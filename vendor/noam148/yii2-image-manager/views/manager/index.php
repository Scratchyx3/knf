...
$this->title = "Foto Upload";
$this->params['breadcrumbs'][] = 'Foto Upload';
?>

<div id="module-imagemanager" class="container-fluid <?=$selectType?>">
	<div class="row">
		<div class="col-xs-12 col-sm-10 col-image-editor">
			<div class="image-cropper">
				<div class="image-wrapper">
					<img id="image-cropper" />
				</div>
				<div class="action-buttons">
                    <button type="button" class="btn btn-success apply-crop">Apply</button>
                    <button type="button" class="btn btn-danger cancel-crop">Cancel</button>
				</div>
			</div>
		</div>
		<div class="col-xs-12 col-sm-10 col-overview">
			<?php Pjax::begin([
		...
		<div class="col-xs-12 col-sm-2 col-options">
			...
			<div class="image-info hide">
				...
				<div class="edit-buttons">
                    <button type="button" class="btn btn-primary crop-image-item">Crop</button>
                    <!--
					<a href="#" class="btn-primary btn-block crop-image-item">
